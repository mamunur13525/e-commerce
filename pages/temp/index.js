    ...
    return (
        <div className="flex w-screen h-screen justify-center items-center">
            ...
            <div className="p-10 flex flex-wrap">
                {
                    selectedAlphabet.map(singleAlphabet => <span className="bg-lime-500 text-white w-20 h-8 m-1 flex justify-center items-center rounded-sm text-lg">{singleAlphabet}</span>)
                }
            </div>
        </div>
    )
