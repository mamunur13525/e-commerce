          ...
          <div className="flex flex-col sm:flex-row  gap-8">
            ...
            <div className="flex-1 -translate-y-5">
              ...
              <p className="text-sm leading-relaxed text-gray-600 max-w-sm mb-6">
                A fast, secure, and easy-to-use online marketplace connecting
                buyers and sellers for everything you need.
              </p>
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  target="_blank"
                  className="w-10 h-10 rounded-full bg-white border border-gray-200 hover:bg-blue-500 hover:text-white hover:border-blue-500 flex items-center justify-center transition-all duration-200 shadow-sm"
                  aria-label="Facebook"
                >
                  <svg
                    className="w-5 h-5"
