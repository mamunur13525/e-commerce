          ...
          <div className="flex-1 overflow-y-auto p-3 pr-0">
            <div className="flex flex-col">
              {displayCartItems.map((item) => (
                <div
                  key={item.productId}
                  className="flex gap-4 rounded-xl overflow-hidden hover:bg-green-50 px-4 py-3 transition-colors"
                >
                  <Link
                    href={"/products/" + item.productId}
                    className="size-16 bg-gray-100 rounded-lg shrink-0 flex items-center justify-center overflow-hidden hover:border"
                  >
                  ...
                  <div className="flex-1 flex items-center justify-between">
                    <div>
                      <Link
                        href={"/products/" + item.productId}
                        className="font-semibold text-[#003d29] line-clamp-1 hover:underline"
                      >
