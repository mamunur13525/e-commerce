...
const SalesOffer = () => {
    return (
        <div className={`h-fit lg:h-[30rem] pb-5 mb-32 bg-[url('https://cdn.shopify.com/s/files/1/2179/9295/files/home1-banner1_ca7416b4-4dd7-40d9-9f74-2071b228dba0.jpg?v=1501465964')]`} >
