  ...
  return (
    <div className={`bg-white lg:py-10 ${classAdd}`}>
      <div className="container mx-auto">
          ...
          {Array.isArray(categoryLists) &&
            categoryLists.map((cat) => (
              <li
                ...
                key={cat?.id}
                className={`text-base hover:text-green-600 uppercase cursor-pointer after:h-[1.8px] after:block after:bg-green-600 after:w-[0] hover:after:w-full after:transition-all ${
        ...
        <div>
          <ProductLists
            productClass="w-[200px] h-[250px] border-r "
