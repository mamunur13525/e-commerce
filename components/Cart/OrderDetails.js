            ...
            <div className="h-full">
                ...
                {!allCartItems.length
                    ...
                    <div className="p-4">
                        ...
                        <div className=''>
                            <Button clickFunc={checkout} classAdd={`flex items-center gap-2 justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase  shadow text-black ${loading && 'cursor-not-allowed'}`}>
                                {
                                    loading ? 
                                    '.....' 
                                    : 
