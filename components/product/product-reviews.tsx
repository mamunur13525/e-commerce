...
export function ProductReviews({ productId }: ProductReviewsProps) {
  ...
  const { data: allReviewsData } = useReviews(
    productId,
    "all",
    "recent",
    1,
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={sortOption} onValueChange={handleSortChange}>
                <SelectTrigger className="w-40 h-9 border-none bg-transparent hover:bg-gray-50 font-semibold focus:ring-0 shadow-none px-2 text-[#003d29]">
                  <SelectValue />
                </SelectTrigger>
                    ...
                    {review.images && review.images.length > 0 && (
                      <div className="flex gap-2 pt-2">
                        {review.images.map((img, i) => (
                          <div
                            key={i}
                            className="relative size-20 rounded-lg overflow-hidden border bg-gray-50"
                          >
                            <Image
                              src={img.url}
