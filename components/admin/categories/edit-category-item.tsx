...
import { AdminCategory } from "@/hooks/api/admin";
...
interface EditCategoryItemProps {
  open: boolean;
  onClose: () => void;
    ...
    >
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the category details for &ldquo;{category?.name}&rdquo;.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <DialogFooter className="mt-6">
            <Button type="button" variant="outline" onClick={() => { onClose(); setShowEmojiPicker(false); }}>
              Cancel
            </Button>
