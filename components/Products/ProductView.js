                            ...
                            <Slider {...sliderSettings}>
                                {
                                    newimages.map((img, ind) => (
                                        <div key={ind} className={`hover:border border-green-700 w-[150px] aspect-square cursor-pointer p-1 ${mainImageShow === img ? 'border' : ''}`}>
                                            <img onClick={() => setMainImageShow(img)} className='w-full aspect-square object-cover' src={img.url} alt="product  image" />
                                        </div>
                                    ))
                                }
                            </Slider>
